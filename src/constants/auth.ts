...
export const AUDIT_ACTIONS = {
  ...
  MEDICINE_DEACTIVATED: "MEDICINE_DEACTIVATED",
  ...
  LOW_STOCK_ALERT_CREATED: "LOW_STOCK_ALERT_CREATED",
  EXPIRY_ALERT_CREATED: "EXPIRY_ALERT_CREATED",
  APPLICATION_ERROR_RECORDED: "APPLICATION_ERROR_RECORDED",
  APPLICATION_ERROR_RESOLVED: "APPLICATION_ERROR_RESOLVED",
  APPLICATION_ERROR_IGNORED: "APPLICATION_ERROR_IGNORED",
...
/**
 * Bahasa Indonesia labels for audit results.
 */
