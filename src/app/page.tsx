    ...
    <main className="min-h-screen bg-page-background">
      ...
      <header className="border-b border-border-default bg-card-surface">
        <section className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 md:px-6">
          ...
          >
            <Link
              className="ts-sm hidden rounded-lg px-3 py-2 text-text-default hover:bg-muted-surface sm:inline-flex"
              href="/"
            >
              Beranda
            </Link>
            ...
            <Link
              className="ts-sm hidden rounded-lg px-3 py-2 text-text-default hover:bg-muted-surface md:inline-flex"
              href="#profil-klinik"
            >
              Profil Klinik
            </Link>
